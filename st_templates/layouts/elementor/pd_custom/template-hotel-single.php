    ...
    <div id="st-content-wrapper">
        ...
        <div class="container">
            ...
            <div class="pd-property-images">
                <?php echo st()->load_template('layouts/elementor/pd_custom/hotel-gallery','',['post_id' => $post_id]); ?>
            </div>
                        ...
                        <div class="left">
                            ...
                            <div class="sub-heading pd-sub-heading">
                                <div class="review-score style-2">
                                    <?php echo st()->load_template('layouts/elementor/common/star', '', ['star' => $hotel_star, 'style' => 'style-2']); ?>
                                </div>
                                <div>
                                    <?php if ($address) {
