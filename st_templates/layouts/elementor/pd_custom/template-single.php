            ...
            */ ?>
            ...
            <div class="container">
                <div class="pd-property-images">
                    <?php echo st()->load_template('layouts/elementor/activity/single/item/gallery', 2, array('gallery_array' => $gallery_array)); ?>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-9 col-md-9">
                            <div class="st-service-header d-flex justify-content-between align-items-center pd-service-header">
                                <div class="left">
