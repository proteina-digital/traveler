...
wp_enqueue_script('single-hotel-detail');
    ...
    while ( have_posts() ): the_post();
        ...
        <div id="st-content-wrapper">
            ...
            <div class="container">
                <div class="pd-property-images">
                    <?php echo st()->load_template('layouts/elementor/pd_custom/hotel-gallery','',['post_id' => $room_id]); ?>
                </div>
                    ...
                    <div class="col-12 col-sm-9">
                        <div class="st-service-header d-flex justify-content-between align-items-center">
                            <div class="left">
                                ...
                                <div class="sub-heading pd-sub-heading">
                        ...
                        <?php echo st()->load_template('layouts/elementor/pd_custom/attributes','',['post_type' => 'hotel_room']);?>

                        <?php echo st()->load_template('layouts/elementor/pd_custom/hotel-checkins','',['post_id' => $hotel_id]); ?>
                        <?php echo st()->load_template('layouts/elementor/pd_custom/hotel-rules','',['post_id' => $hotel_id]); ?>

                        <?php echo st()->load_template('layouts/elementor/hotel/single/item/review','',['post_id' => $hotel_id]); ?>
